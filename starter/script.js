...
function generatePassword() {
 passwordlength = prompt ("Choose a number between 10 to 64");
...
return lasPass;
// user needs to choose a number between 10 to 64 but if user choose a number less than 10 it will return false
} else {
  alert("Please chose a number between 10 to 64");
  return false; 
} 
